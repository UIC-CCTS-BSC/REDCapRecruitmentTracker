...
The workflow of the modules of this interactive online dashboard is illustrated below. Recruitment Tracker displays the dataset in four modules of interest for users: "[Verification & Setting](#module-1.-verification-setting)," "[Project Summary](#module-2.-project-summary)," "[Recruitment Tracking](#module-3.-recruitment-tracking),"
...
```{r, fig.cap="Workflow and modules of the interactive web-based dashboard for REDCap Recruitment Tracker R Shiny App", include = FALSE}
